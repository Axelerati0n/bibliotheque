<?php $page_title = "La Belle et la Bête";
...
<?php require "../requires/nav.php"; ?>
 ...
 <figure class="left">
   <div class="zoom">
     <a href="#"><img src="(../../../img/Livres/Conte/la-belle-et-la-bete_2.jpg" alt="La belle et la bête"></a>
    </div>
  </figure>
  <article class="essayons">
    <p><strong>Titre</strong> : La Belle et la Bête
      ...
      <br><strong>Nombre de pages</strong> : 128
      <br><strong>Annoteur</strong> : Isabelle de Lisle</p>
     </article>
     <section class="info">
