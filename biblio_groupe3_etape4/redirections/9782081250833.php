...
<?php require "../requires/nav.php"; ?>
 ...
 <figure class="left">
   <div class="zoom">
     <a href="#"><img src="(../../../img/Livres/9782081250833.jpg" alt="Graal, le chevalier sans nom"></a>
    </div>
  </figure>
     <article class="essayons">
      <p><strong>Titre</strong> : Graal, le chevalier sans nom
        ...
        <br><strong>Nombre de pages</strong> : 354
       </article>
       <section class="info">
