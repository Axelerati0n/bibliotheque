...
<?php require "../requires/nav.php"; ?>
 ...
 <figure class="left">
   <div class="zoom">
     <a href="#"><img src="(../../../img/Livres/9782253151432.jpg" alt="Simetierre"></a>
    </div>
  </figure>
     <article class="essayons">
      <p><strong>Titre</strong> : Simetierre
        ...
        <br><strong>Nombre de pages</strong> : 636
        <br><strong>Traducteur</strong> : François Lasquin</p>
       </article>
       <section class="info">
