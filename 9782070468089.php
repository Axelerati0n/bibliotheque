...
<?php require "../requires/nav.php"; ?>
 ...
 <figure class="left">
   <div class="zoom">
     <a href="#"><img src="(../../../img/Livres/Horreur/frankenstein.jpg" alt="Frankenstein"></a>
    </div>
  </figure>
  <article class="essayons">
    <p><strong>Titre</strong> : Frankestein
      ...
      <br><strong>Nombre de pages</strong> : 336
      <br><strong>Traducteur</strong> : Alain Morvan</p>
     </article>
     <section class="info">
