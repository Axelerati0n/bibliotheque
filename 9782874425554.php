...
<?php require "../requires/nav.php"; ?>
 ...
 <figure class="left">
   <div class="zoom">
     <a href="#"><img src="(../../../img/Livres/Bande-dessinee/les_simpson_2.jpg" alt="Les Simpson"></a>
    </div>
  </figure>
     <article class="essayons">
      <p><strong>Titre</strong> : Les Simpson : Un sacré foin
        <br><strong>Auteur</strong> : Matt Groenning
        ...
        <br><strong>Nombre de pages</strong> : 48</p>
       </article>
       <section class="info">
