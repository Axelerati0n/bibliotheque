<?php $page_title = "Jojo's Bizzares Adventures";
require "../requires/head_header.php"; ?>

<?php require "../requires/nav.php"; ?>

  <section>
    <h1>Jojo's Bizzares Adventures</h1>
 <figure class="left">
   <div class="zoom">
     <a href="#"><img src="(../../../img/Livres/Manga/sbr_17__9782756056968.jpg" alt="Jojo's bizzares adventures"></a>
    </div>
  </figure>
     <article class="essayons">
      <p><strong>Titre</strong> : Jojo's Bizzares Adventures
      <br><strong>Auteur</strong> : Hirohiko Araki
      <br><strong>Genre</strong> : Manga
      <br><strong>ISBN</strong> : 978-2-7560-5696-8
      <br><strong>Editeur</strong> : Delcourt
      <br><strong>Date de publication</strong> : 23/09/2015
      <br><strong>Nombre de pages</strong> : 224
      <br><strong>Traductrice</strong> : Satoko Fujimoto</p>
     </article>
     <section class="info">
